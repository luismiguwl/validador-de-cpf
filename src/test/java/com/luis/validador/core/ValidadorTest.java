...
class ValidadorTest {
    ...
    public void cpfComNumerosIguaisTest() {
        ...
        assertThatThrownBy(() -> validador.verificarSeNumerosDoCPFNaoSaoIguais()).isInstanceOf(CPFInvalidoException.class);
    }
    ...
    public void cpfPossuiApenasCaracteresAceitos() {
        ...
        assertThatThrownBy(() -> validador.verificarSeExistemApenasCaracteresValidos()).isInstanceOf(CPFInvalidoException.class);
    }
    ...
    public void cpfComLengthDiferenteDeOnzeTest() {
        ...
        assertThatThrownBy(() -> validador.verificarSeCPFPossuiOnzeNumeros()).isInstanceOf(CPFInvalidoException.class);
    }
    ...
    public void validarPrimeiroDigitoInvalidoTest() {
        CPF cpf = new CPF("236.865.184-18");
        validador = new Validador(cpf);
    ...
    public void multiplicarNumeroDoCpfTest() {
        CPF cpf = new CPF("236.865.184-58");
        validador = new Validador(cpf);
    ...
    public void cpfVazioTest() {
        ...
        assertThatThrownBy(() -> validador.validar()).isInstanceOf(CPFInvalidoException.class);
    }
    ...
    public void cpfNuloTest() {
        ...
        assertThatThrownBy(() -> validador.verificarSeCpfNaoEhNulo()).isInstanceOf(CPFInvalidoException.class);
    }
}
